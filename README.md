...
## Statistics of categories after basic mapping from schema traits.
|           |                | **ar** | **de** | **en** | **es** | **nl** | **tr** |
|-----------|----------------|--------|--------|--------|--------|--------|--------|
| **test**  | **cat_maybe_** |    626 |    759 |    650 |    785 |    447 |    656 |
...
| **train** | **cat_maybe_** |    597 |   1944 |  30493 |   6858 |   1049 |   2005 |
...
| cat_maybe_ | potentially toxic          |
|------------|----------------------------|
| cat_justIn | just inappriopriate        |
| cat_differ | different kind of toxicity |
| cat_intimi | intimidation like          |
| cat_threat | threat like                |
| cat_infe_n | inferior nature            |
